...
const SOURCE_HTML_CREDIT = `<!--
  Generated by Adawwa v1.0.0 — https://adawwa.com
...
Static single-page portfolio generated by [Adawwa](https://adawwa.com) v1.0.0.

Designed and Developed by [Griffinzone (PVT) Ltd](https://griffinzone.com).

## Credits

- Generator: **Adawwa** v1.0.0 — https://adawwa.com
