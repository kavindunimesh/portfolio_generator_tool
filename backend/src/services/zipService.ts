...
const SOURCE_HTML_CREDIT = `<!--
  Generated by Adawwa v1.1.1 — https://adawwa.com
...
export async function renderPortfolioFiles(row: PortfolioRow, workDir: string) {
  ...
  const readmeParts = [
    ...
    '',
    'Static single-page portfolio generated by [Adawwa](https://adawwa.com) v1.1.1.',
    '',
    'Designed and Developed by [Griffinzone (PVT) Ltd](https://griffinzone.com).',
    '',
    '## Credits',
    '',
    '- Generator: **Adawwa** v1.1.1 — https://adawwa.com',
